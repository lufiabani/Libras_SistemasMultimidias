...
categories = {
    ...
    "Frutas": ["PERA", "BANANA", "UVA", "LIMAO", "MANGA", "MELAO", "MELANCIA", "AMORA", "COCO", "ROMA", 
               ...
               "LIMAO CRAVO", "BANANA PRATA", "BANANA OURO", "CAQUI", "INGA", "BANANA PRATA", "BANANA OURO", 
               "LIMAO GALEGO", "LIMAO CRAVO"],
    "Objetos": ["MESA", "CADEIRA", "POTE", "CANETA", "LAPIS", "LIVRO", "TESOURA", "PAPEL", "LAMPADE", 
